...
call s:HL('Cursor', s:dark_gray, s:peach, '')
...
call s:HL('NonText', s:peach, '', '')

call s:HL('CursorLine', '', s:shade, '')
call s:HL('CursorColumn', '', s:shade, '')
call s:HL('ColorColumn', '', s:white, '')

call s:HL('StatusLine', s:dark_purple, s:pink, 'bold')
...
call s:HL('VertSplit', s:pink, s:pink, 'bold')

call s:HL('PMenu', s:light_gray, s:shade, 'none')
call s:HL('PMenuSel', s:dark_gray, s:yellow, 'none')
call s:HL('PMenuSbar', s:dark_gray, s:dark_blue, 'none')
...
call s:HL('Normal', '#9E9C9B', s:background, 'none')
